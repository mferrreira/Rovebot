...
Your task is to draft a reply based on the email and its classification.
...
- partnership_tier `low`: Write a polite, gracious decline. Thank them for reaching out, acknowledge their brand, and explain that it is not the right fit at this time. Leave the door open for future contact. Do not over-explain.
